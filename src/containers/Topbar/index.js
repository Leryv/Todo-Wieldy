  ...
  return (
    <Header>
      ...
      <ul className="gx-header-notifications gx-ml-auto">
        ...
        <li>
          <Radio.Group value ={setThemeType}>
            {/* <Radio.Button>Lite</Radio.Button> */}
            <Radio.Button onChange={switchDarkTheme}>Dark</Radio.Button>
            <Radio.Button onChange={switchSemiTheme}>Semi</Radio.Button>
            <Radio.Button onChange={switchLiteTheme}>Lite</Radio.Button>
          </Radio.Group>
        </li>
